...
Sudoku::Sudoku(QWidget *parent,int level) :
    QMainWindow(parent),
    ui(new Ui::Sudoku)
{
...
void Sudoku::on_actionOpen_triggered()
{
    ...
    QFile inFile(QFileDialog::getOpenFileName(NULL, "Open", QDir::homePath(), "*.su"));
...
void Sudoku::on_actionSave_triggered()
{
    ...
    QFile outFile(dialog.getSaveFileName(NULL, "Save", QDir::homePath()+".su","Any Files (*.su)" ));
...
/*!
*\brief Funcion Booleana Sudoku Completo
*\details Esta funcion nos dice si ya todas las casillas del sudoku estan llenas
*\@return true/false
*/
...
/*!
*\brief Game Mode Normal (Modo de Juego)
*\details Esta opcion no da ayuda al usuario solo una retroalimentacion visual de donde se ubica en el tablero
*/
...
/*!
*\brief Game Mode Hint (Modo de Juego Hint)
*\details Esta opcion sirve para ayudar al usuario desactivando los numeros que no se pueden usar en la celda seleccionada
*/
...
/*!
*\brief Game Mode Clue(Modo de Juego)
*\details Esta opcion muestra en la tabla con color amarillo todos las casillas en donde se puede ubicar el numero seleccionado
*/
...
/*!
*\brief Nivel FACIL
*\details Nos genera la tabla desabilitando 45 casillas de la tabla
*/

void Sudoku::levelEasy()
{
    invalidateWindow();
    ui->groupBox_2->setEnabled(true);
    for (int i = 0; i < 9; i++)
...
/*!
*\brief Nivel DIFICIL
*\details Nos genera la tabla desabilitando 30 casillas de la tabla
*/

void Sudoku::levelMedium()
{
    invalidateWindow();
    ui->groupBox_2->setEnabled(true);
    for (int i = 0; i < 9; i++)
